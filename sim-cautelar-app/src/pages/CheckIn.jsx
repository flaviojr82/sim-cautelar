...
const CheckIn = () => {
  ...
  if (step === 'duplicate') return ( <LayoutCheckIn><div className="result-card fade-in"><div style={{background: '#ECFDF5', borderRadius: '50%', padding: 12, marginBottom: 16}}><CalendarCheck size={48} color="#059669" /></div><h2 style={{color: '#1E2939'}}>Tudo certo!</h2><p style={{color: '#64748B', marginBottom: 24}}>Apresentação já realizada hoje.</p><button onClick={() => navigate('/home')} className="btn-primary mt-4">Voltar</button></div></LayoutCheckIn> );
